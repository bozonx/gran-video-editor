  ...
  <div class="flex flex-col w-full h-full">
    ...
    <div class="flex-1 flex items-center justify-center min-h-0 bg-black relative">
      ...
      <audio
        ...
        @ended="onPause"
      ></audio>
      <div v-if="type === 'audio'" class="flex flex-col items-center justify-center absolute inset-0 text-gray-400">
    ...
    <div class="flex flex-col px-4 py-2 border-t border-gray-700 bg-gray-900 shrink-0 gap-2">
      <!-- Scrubber -->
      <div 
        class="h-2 bg-gray-700 rounded-full w-full cursor-pointer relative group"
        @click="seek"
      >
        <div 
